...
export default function AdminReservationPage() {
  ...
  const save = async () => {
    try {
      ...
      if (!customerName.trim()) return setError("customerName y  status son requeridos");
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Stack spacing={2} sx={{ mb: 2 }}>
          <Stack direction={{ xs: "column", md: "row" }} spacing={2}>
            ...
            <TextField label="Nombres" value={customerName} onChange={(e) => setCustomerName(e.target.value)} fullWidth />
